...
(function() {
    ...
    var translations = {
        en: {
            ...
            "install.android.1": "Open <strong>app.vim.quivi.it</strong> with Chrome.",
        ...
        it: {
            ...
            "install.android.1": "Apri <strong>app.vim.quivi.it</strong> con Chrome.",
        ...
        ar: {
            ...
            "hero.openApp": "افتح app.vim.quivi.it",
            "hero.installLink": "طريقة التثبيت",
            "access.ariaLabel": "وصول سريع إلى تطبيق VIM",
            "access.title": "وصول سريع",
            "access.qrAlt": "رمز QR لفتح app.vim.quivi.it",
            "access.qrNote": "إذا كنت تستخدم الهاتف، اضغط على الرابط. من الكمبيوتر، امسح رمز QR بكاميرا الهاتف.",
            "install.title": "ثبت تطبيق PWA على الشاشة الرئيسية",
            "install.ios.1": "افتح <strong>app.vim.quivi.it</strong> باستخدام Safari.",
            ...
            "install.android.1": "افتح <strong>app.vim.quivi.it</strong> باستخدام Chrome.",
